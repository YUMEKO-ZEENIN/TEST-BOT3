...
global.authFile = 'RaizelBotSession'
...
(async () => {
global.conns = [];
const mainBotAuthFile = 'RaizelBotSession';
try {
...
let prekey = []
let directorio = readdirSync("./RaizelBotSession")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-')
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./RaizelBotSession/${files}`)
})
} 
...
const directories = ['./RaizelBotSession/', './GataJadiBot/']
