...
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '© by zack', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '© by zack', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '© by zack', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (db.data.chats[m.chat].reaction && m.text.match(/(زاك|ناروتو|يا بوت|بوت|رايزل|فلاش|لايت|سوكونا|ايتاتشي|البوت|بوتي|بوتك|بوتات|المطور)/gi)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '【🦇┇𝐑𝐀𝐈𝐙𝐄𝐋 𝐁𝐎𝐓┇🦇 】') :
...
"thumbnail": apii.data, 
"title": [wm, 'RaizelBot' + gt + '🦇', '【🦇┇𝐑𝐀𝐈𝐙𝐄𝐋 𝐁𝐎𝐓┇🦇 】'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://whatsapp.com/channel/0029VaoUBmSKmCPIIiEatx1H' }}}, { quoted: fkontak2 })
apii.data = ''
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, 'RaizelBot' + gt + '🦇', '【🦇┇𝐑𝐀𝐈𝐙𝐄𝐋 𝐁𝐎𝐓┇🦇 】'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
