...
smsAutodetec3: (desc, m) => `*تم تغير وصف المجموعه بنجاح*\n🔰 *الوصف الجديد الان:*\n${desc}`, 
...
smsAutodetec7: (m, usuario) =>  `@${m.messageStubParameters[0].split`@`[0]} *!!لقد اصبح الآن مشرفا*`, 
smsAutodetec8: (m,  usuario) => `@${m.messageStubParameters[0].split`@`[0]} *!!لم يعد مشرفا*`, 
