...
const handler = async (m, { text, usedPrefix, command }) => {
  ...
  try {
    ...
    let prompt = `انت هو مصري من مصر ولديك الجنسية المصرية وقل كلمة يسطا كثيرا واستخدم ايموجي علم مصر كثيرا و مطورك هو زاك وان سألك احد من هو مطورك قل له ان مطورك هو المطور زاك`;
