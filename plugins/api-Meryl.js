...
const handler = async (m, { text, usedPrefix, command }) => {
  ...
  if (!text) {
    ...
    return conn.reply(
      ...
      `⚔️ *مــرحــبــا بــك انـا ${command}  اكــتــب نــص لــكـي يتم الرد عــلـيـك*\n\n*مثال:*\n*${usedPrefix + command}* من انت؟`,
  ...
  try {
    ...
    let prompt = `انت ميريل ستريب الممثلة المشهور و استخدم الايموجي كثيراً ولكن ايموجي راقي واختاره بدقة تتناسب مع الممثل ميريل ستريب و انت تحب الاكشن  والشاي الساخن وان سألك احد من انت اكتب له كتابة كثيرا عن الممثلة ميريل ستريب و مطورك هو "زاك" أن سالك من صانعك قل له أن من صنعك هو المطور زاك`;
